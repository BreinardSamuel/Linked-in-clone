        ...
        <div class=" container text-center sign-in-center">
            ...
            <main class="form-signin w-100 m-auto">
                <form autocomplete="off">
                    <img class="mb-4" src="<?php echo base_url("/writable/defaults/defaultlogin.png") ?>" alt="" width="72" height="72">
                    ...
                    <button class="w-100 btn btn-lg btn-dark" data-Base_url="<?php echo base_url() ?>"  id="login_btn" type="button">LOGIN</button>
